...
<div class="drug-use-form">
   ...
   <?= $form->field($model, 'drug_id')->input('hidden',['value'=>$drug_id])?>

    <?= $form->field($model, 'drug_name')->textInput(['maxlength' => true,'value'=>$drug_name]) ?>
    </div></div>
    <div class="row">
        <div class="col-md-2">
    <?= $form->field($model, 'total_now')->textInput(['value'=>$total_now]) ?>
        </div>
        <div class="col-md-2">
